	...
	if(motor_mode==Motor_Mode_TB)
	{
		if(Motor_Flag)
		{
			switch(step)
			{
				...
				case Motor_4Step_SPD:	OCR0B=130;				step=Motor_5Step_SPD;		break;
				case Motor_5Step_SPD:	OCR0B=130;				step=Motor_6Step_SPD;		break;
				case Motor_6Step_SPD:	OCR0B=130;				step=Motor_Max_SPD;			break;
				case Motor_Max_SPD:		OCR0B=130;				step=Motor_Max_SPD;			break;
				default : break;
		...
		else
		{
			switch(step)
			{
				...
				case Motor_4Step_SPD:	OCR0B=130;				step=Motor_3Step_SPD;		break;
				case Motor_5Step_SPD:	OCR0B=130;				step=Motor_4Step_SPD;		break;
				case Motor_6Step_SPD:	OCR0B=130;				step=Motor_5Step_SPD;		break;
				case Motor_Max_SPD:		OCR0B=130;				step=Motor_6Step_SPD;		break;
				default : break;
